...
function TaskForm({ reload }) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <input
        className="mt-5 mr-5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black"
        value={title}
